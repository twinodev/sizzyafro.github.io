...
function Nav(){
    return(
        <nav className="flex justify-between items-center p-5 bg-gradient-to-r from-orange-500 to-blue-500 rounded-[15px] m-2">
            ...
            <div className="ml-auto"  >  
                <Link href="https://www.paypal.com/ncp/payment/VY44H6DSDJKJ4" >
                  <button className="hover:bg-white bg-black rounded-lg p-2 hover:text-black text-white hover:animate-pulse">
                    Donate
                  </button>
                </Link>
            </div>
