...
export default function Profile(){
    return(
        <div className="rounded-xl  w-full m-0 md:h-100
                         flex-col p-1">
            <Image className=" bg-gradient-to-r from-purple-500 to-blue-500 m-auto m-0 p-0 rounded-full border-2  border-blue-500 " src="/images/me.png" width={200} height={100} alt="Twinomujuni CEO"/>
            <div className="rounded-xl bg-white shadow-blue-500 shadow-2xl text-center md:mt-1 m-auto md:p-4">
